...
def _get_power(time: datetime, peak_power_per_generator: int = 10):
    ...
    vlvCal = vlv - _get_noise(peak_power_per_generator * 0.1)

    usy = peak_power_per_generator - _get_noise(peak_power_per_generator * 0.1)

    cal = peak_power_per_generator - _get_noise(peak_power_per_generator * 0.1)

    aza = peak_power_per_generator - _get_noise(peak_power_per_generator * 0.1)
