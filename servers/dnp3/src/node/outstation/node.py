...
class Outstation(Node):
    ...
    def __init__(
        ...
        self._stack_config: asiodnp3.OutstationStackConfig = self._configure_stack(
    ...
    def _configure_stack(
        self, local_addr: int, remote_addr: int
        ...
        stack_config = asiodnp3.OutstationStackConfig(
            opendnp3.DatabaseSizes.AllTypes(self._var_len)
        )
        stack_config.outstation.eventBufferConfig = (
            opendnp3.EventBufferConfig().AllTypes(self._var_len)
        )
